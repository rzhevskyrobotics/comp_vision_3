...
Сравнение затраченной памяти(согласно утилите psutil python3):

|              | AlexNet | ResNet101 | VGG16 |
| ------------ | ------- | --------- | ----- |
| Память, байт | 584     | 584       | 384   |
